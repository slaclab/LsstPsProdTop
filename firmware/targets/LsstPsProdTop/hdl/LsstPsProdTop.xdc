...
set_property PACKAGE_PIN W21 [get_ports {sync_DCDC[0]}]
set_property PACKAGE_PIN W22 [get_ports {sync_DCDC[1]}]
set_property PACKAGE_PIN AA20 [get_ports {sync_DCDC[2]}]
...
set_property PACKAGE_PIN W14 [get_ports {reb_on[0]}]
set_property PACKAGE_PIN Y14 [get_ports {reb_on[1]}]
set_property PACKAGE_PIN AB11 [get_ports {reb_on[2]}]
...
set_property PACKAGE_PIN T1 [get_ports {dout0[20]}]
set_property PACKAGE_PIN D21 [get_ports {dout0[19]}]
set_property PACKAGE_PIN B21 [get_ports {dout0[18]}]
set_property PACKAGE_PIN F20 [get_ports {dout0[17]}]
set_property PACKAGE_PIN B20 [get_ports {dout0[16]}]
set_property PACKAGE_PIN C19 [get_ports {dout0[15]}]
set_property PACKAGE_PIN B17 [get_ports {dout0[14]}]
...
set_property PACKAGE_PIN M18 [get_ports {dout0[6]}]
set_property PACKAGE_PIN K19 [get_ports {dout0[5]}]
set_property PACKAGE_PIN J20 [get_ports {dout0[4]}]
set_property PACKAGE_PIN G20 [get_ports {dout0[3]}]
set_property PACKAGE_PIN H17 [get_ports {dout0[2]}]
set_property PACKAGE_PIN H14 [get_ports {dout0[1]}]
set_property PACKAGE_PIN H13 [get_ports {dout0[0]}]
...
set_property PACKAGE_PIN T3 [get_ports {dout1[20]}]
set_property PACKAGE_PIN E21 [get_ports {dout1[19]}]
set_property PACKAGE_PIN B22 [get_ports {dout1[18]}]
set_property PACKAGE_PIN F19 [get_ports {dout1[17]}]
set_property PACKAGE_PIN E18 [get_ports {dout1[16]}]
set_property PACKAGE_PIN C18 [get_ports {dout1[15]}]
set_property PACKAGE_PIN A14 [get_ports {dout1[14]}]
...
set_property PACKAGE_PIN M22 [get_ports {dout1[6]}]
set_property PACKAGE_PIN K18 [get_ports {dout1[5]}]
set_property PACKAGE_PIN L21 [get_ports {dout1[4]}]
set_property PACKAGE_PIN H20 [get_ports {dout1[3]}]
set_property PACKAGE_PIN H15 [get_ports {dout1[2]}]
set_property PACKAGE_PIN J14 [get_ports {dout1[1]}]
set_property PACKAGE_PIN J16 [get_ports {dout1[0]}]
...
set_property PACKAGE_PIN U1 [get_ports {din[20]}]
set_property PACKAGE_PIN G21 [get_ports {din[19]}]
set_property PACKAGE_PIN A21 [get_ports {din[18]}]
set_property PACKAGE_PIN D20 [get_ports {din[17]}]
set_property PACKAGE_PIN A20 [get_ports {din[16]}]
set_property PACKAGE_PIN E19 [get_ports {din[15]}]
set_property PACKAGE_PIN B18 [get_ports {din[14]}]
...
set_property PACKAGE_PIN L18 [get_ports {din[6]}]
set_property PACKAGE_PIN L19 [get_ports {din[5]}]
set_property PACKAGE_PIN J21 [get_ports {din[4]}]
set_property PACKAGE_PIN K21 [get_ports {din[3]}]
set_property PACKAGE_PIN H18 [get_ports {din[2]}]
set_property PACKAGE_PIN G17 [get_ports {din[1]}]
...
set_property PACKAGE_PIN G16 [get_ports {SDA_ADC[0]}]
set_property PACKAGE_PIN G15 [get_ports {SCL_ADC[0]}]
set_property PACKAGE_PIN J15 [get_ports {SDA_ADC[1]}]
set_property PACKAGE_PIN G18 [get_ports {SCL_ADC[1]}]
set_property PACKAGE_PIN H22 [get_ports {SDA_ADC[2]}]
set_property PACKAGE_PIN J22 [get_ports {SCL_ADC[2]}]
set_property PACKAGE_PIN M21 [get_ports {SDA_ADC[3]}]
set_property PACKAGE_PIN K22 [get_ports {SCL_ADC[3]}]
set_property PACKAGE_PIN H19 [get_ports {SDA_ADC[4]}]
set_property PACKAGE_PIN J19 [get_ports {SCL_ADC[4]}]
set_property PACKAGE_PIN N22 [get_ports {SDA_ADC[5]}]
set_property PACKAGE_PIN L20 [get_ports {SCL_ADC[5]}]
set_property PACKAGE_PIN N19 [get_ports {SDA_ADC[6]}]
set_property PACKAGE_PIN N18 [get_ports {SCL_ADC[6]}]
...
set_property PACKAGE_PIN C17 [get_ports {SDA_ADC[14]}]
set_property PACKAGE_PIN D17 [get_ports {SCL_ADC[14]}]
set_property PACKAGE_PIN F18 [get_ports {SDA_ADC[15]}]
set_property PACKAGE_PIN D19 [get_ports {SCL_ADC[15]}]
set_property PACKAGE_PIN A19 [get_ports {SDA_ADC[16]}]
set_property PACKAGE_PIN A18 [get_ports {SCL_ADC[16]}]
set_property PACKAGE_PIN C22 [get_ports {SDA_ADC[17]}]
set_property PACKAGE_PIN C20 [get_ports {SCL_ADC[17]}]
set_property PACKAGE_PIN D22 [get_ports {SDA_ADC[18]}]
set_property PACKAGE_PIN E22 [get_ports {SCL_ADC[18]}]
set_property PACKAGE_PIN F21 [get_ports {SDA_ADC[19]}]
set_property PACKAGE_PIN G22 [get_ports {SCL_ADC[19]}]
set_property PACKAGE_PIN V2 [get_ports {SDA_ADC[20]}]
set_property PACKAGE_PIN U2 [get_ports {SCL_ADC[20]}]
...
#create_clock -period 16.000 -name stableClk [get_pins EthGtp7Wrapper_Inst/IBUFDS_GTE2_Inst/ODIV2]
#create_clock -period 8.000 -name eth125MHz [get_pins {EthGtp7Wrapper_Inst/ClockManager7_Inst/ClkOutGen[0].U_Bufg/O}]
#create_clock -period 16.000 -name eth62p5MHz [get_pins {EthGtp7Wrapper_Inst/ClockManager7_Inst/ClkOutGen[1].U_Bufg/O}]
#set_clock_groups -asynchronous -group [get_clocks stableClk] -group [get_clocks eth125MHz] -group [get_clocks eth62p5MHz]
